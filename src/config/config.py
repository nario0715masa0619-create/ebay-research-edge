...
class Config:
    ...
    @property
    def mercari_exclude_keywords(self) -> list:
        """
        Get keywords to exclude from Mercari searches.

        Returns:
            List[str]: Keywords that should exclude results.
                      Example: ['sleeve', 'box', 'file']
        """
        return self.category_config['mercari']['exclude_keywords']
